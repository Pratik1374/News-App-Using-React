    ...
    return (
      ...
      />
        <Routes>
          ...
          <Route exact path="/entertainment" element={ <News setProgress={this.setProgress} key="" pageSize={6} country="in" category="entertainment" />}></Route>
          <Route exact path="/entertainment" element={ <News setProgress={this.setProgress} key="" pageSize={6} country="in" category="entertainment" />}></Route>
          <Route exact path="/general" element={ <News setProgress={this.setProgress} key="" pageSize={6} country="in" category="general" />}></Route>
          <Route exact path="/general" element={ <News setProgress={this.setProgress} key="" pageSize={6} country="in" category="general" />}></Route>
